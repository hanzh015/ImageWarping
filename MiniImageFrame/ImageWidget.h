...
public slots:
	...
	void IDWWarp_();												// Warp points using IDW method;
	void RBFWarp_();												// Warp points using RBF method;
...
private:
	...
	void		generate_Warpped_Image(Function_Status_ stat);
	QRgb		mask(int i,int j,QImage image_);
};
